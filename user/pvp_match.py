...
from environment.agent import run_real_time_matcha
...
opponent = SubmittedAgent(file_path=r"D:\My stuff\UTMIST-AI2\checkpoints\experiment_23\rl_model_255379_steps")
match_time = 99999
